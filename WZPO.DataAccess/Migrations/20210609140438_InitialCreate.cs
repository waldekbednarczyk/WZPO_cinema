        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Seances_CinemaRooms_CinemaRoomId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CanEditSeance = table.Column<bool>(type: "bit", nullable: false),
                    CanEditCinemaRoom = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrivelageName", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PrivelageName_Users_AdministratorId",
                        column: x => x.AdministratorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PrivelageName_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Films_Seances_SeanceId",
                        column: x => x.SeanceId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Films_SeanceId",
                table: "Films",
                column: "SeanceId");

            migrationBuilder.CreateIndex(
                name: "IX_PrivelageName_AdministratorId",
                table: "PrivelageName",
                column: "AdministratorId");

            migrationBuilder.CreateIndex(
                name: "IX_PrivelageName_UserId",
                table: "PrivelageName",
                column: "UserId");
